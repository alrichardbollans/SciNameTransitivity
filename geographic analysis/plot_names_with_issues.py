...
_input_path = os.path.join('..', 'WCVP_methods', 'outputs', 'v10_v14')
issue_df = pd.read_csv(os.path.join(_input_path, 'species_results.csv'))
v10_taxa = pd.read_csv(os.path.join('..', 'WCVP_methods', 'inputs', 'v10_taxa.csv'))
v10_taxa['taxon_name_w_authors'] = add_authors_to_col(v10_taxa, 'taxon_name')
v14_taxa = pd.read_csv(os.path.join('..', 'WCVP_methods', 'inputs', 'v14_taxa.csv'))
